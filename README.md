# `Virtual Terminal` — the seed for AngularJS apps
...
To get you started you can simply clone the `Virtual Terminal` repository and install the dependencies:

### Prerequisites

You need git to clone the `Virtual Terminal` repository. You can get git from [here][git].

We also use a number of Node.js tools to initialize and test `Virtual Terminal`. You must have Node.js
and its package manager (npm) installed. You can get them from [here][node].

### Clone `Virtual Terminal`

Clone the `Virtual Terminal` repository using git:

```
git clone https://github.com/angular/Virtual Terminal.git
cd Virtual Terminal
```

If you just want to start a new project without the `Virtual Terminal` commit history then you can do:

```
git clone --depth=1 https://github.com/mntry/VirtualTerminal <your-project-name>
```
